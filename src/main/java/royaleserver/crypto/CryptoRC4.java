...
public class CryptoRC4 {
    ...
    public byte[] decryptPacket(byte[] data, int id) {
        System.out.println("Handled client packet: " + id);
        try {
    ...
    public byte[] encryptPacket(byte[] data, int id) {
        System.out.println("Handled server packet: " + id);
        try {
