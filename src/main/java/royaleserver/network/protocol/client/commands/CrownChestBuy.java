...
public final class CrownChestBuy extends ClientCommand {
	public static final short ID = Commands.CROWN_CHEST_BUY;

	public Chest chest;

	public CrownChestBuy() {
		super(ID);
	}

	@Override
	public ClientCommand create() {
		return new CrownChestBuy();
	}

	@Override
	public boolean handle(ClientCommandHandler handler) throws Throwable {
		return handler.handleCrownChestBuy(this);
	}
